...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'schedule_game', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Location'], null=True))

    def backwards(self, orm):

        # Changing field 'Game.location'
        db.alter_column(u'schedule_game', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['schedule.Location']))
