...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'schedule_game', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['schedule.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.location'
        db.delete_column(u'schedule_game', 'location_id')
